...
const InputSlider = (props:InputProps)=> {
  ...
  const {title, value,min, max,  update, icon, tabIndex, unit,sx} = props;
  ...
  return (
    <Box component="div" sx={{
      ...
      <Typography id="input-slider" gutterBottom variant='body2' sx={{whiteSpace:"nowrap", fontSize:"12px"}}> 
        {title}
      </Typography>
      <Grid container spacing={1} alignItems="center">
        <Grid item >  
          <Box sx={{position:"relative", top:"5px"}} >{icon}</Box>
        </Grid>
